...
void run_protocol() {
  ...
  auto start2 = std::chrono::steady_clock::now();
    ...
    RPoint pa = Pa + Qa * na;
    int order_a = pa.order2();
    IsogenyChain iso_a(E, pa, 2, order_a);
  ...
  auto start3 = std::chrono::steady_clock::now();
    ...
    RPoint pb = Pb + Qb * nb;
    int order_b = pb.order3();
    IsogenyChain iso_b(E, pb, 3, order_b);
  ...
  auto start5 = std::chrono::steady_clock::now();
    ...
    IsogenyChain iso_a2(Eb, pa2, 2, order_a);
  ...
  auto start6 = std::chrono::steady_clock::now();
    ...
    IsogenyChain iso_b2(Ea, pb2, 3, order_b);
  ...
  auto start7 = std::chrono::steady_clock::now();
    ...
    cout << endl << "-------------------------" << endl << endl;
    cout << "Alice's key: " << iso_a2.e1().str() << endl << endl;
    cout << "Bob's key: " << iso_b2.e1().str() << endl << endl;
